...
class ExpandLinkTest extends PHPUnit_Framework_TestCase
{
    ...
    public function provider()
    {
        return [
            ...
            ['ShareASale.html', 'https://www.darngoodyarn.com/collections/yarn-bowls/products/blue-agate-w-lid-ceramic-yarn-bowl?sscid=41k3_64bv9', 'https://www.darngoodyarn.com/collections/yarn-bowls/products/blue-agate-w-lid-ceramic-yarn-bowl?sscid=41k3_64bv9', true],
        ];
    }
